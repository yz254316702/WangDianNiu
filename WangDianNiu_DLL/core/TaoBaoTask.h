...
typedef enum {
	...
	//add 20151208
	TASK_STATUS_EXPAND_LOWPRICE_SERVICE,
	TASK_STATUS_SELECT_LOWPRICE_SERVICE,
...
public:
	bool m_bMinMaxSetted;
	bool m_bLowPriceSetted;
	bool m_bSendPlaceSetted;
